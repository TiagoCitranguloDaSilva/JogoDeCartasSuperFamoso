...
function Randomize() {
  ...
  while (a) {
    ...
    if (CartasPossiveis[cor].length > 0) {
      ...
      CartasPossiveis[0].length == 0 &&
      CartasPossiveis[1].length == 0 &&
      CartasPossiveis[2].length == 0 &&
      CartasPossiveis[3].length == 0
    ) {
...
function Change(element) {
  ...
  if (
    document.getElementById("cartas").children[0].classList[1] == element.classList[1] ||
    value == document.getElementById("cartas").innerText
  ) {
...
function adversario() {
  ...
  for (let c = 0; c < document.getElementById("ad").children.length; c++) {
    if (
      document.getElementById("ad").children[c].classList[1] ==
        document.getElementById("cartas").children[0].classList[1] ||
      document.getElementById("ad").children[c].innerText ==
        document.getElementById("cartas").children[0].innerText
    ) {
...
function pescar(algo) {
  ...
  if (algo == "mao") {
    for (let c = 0; c < document.getElementById("mao").children.length; c++) {
      if (
        document.getElementById("mao").children[c].classList[1] ==
          document.getElementById("cartas").children[0].classList[1] ||
        document.getElementById("mao").children[c].innerText ==
          document.getElementById("cartas").children[0].innerText
      ) {
        achou = "yep";
      }
